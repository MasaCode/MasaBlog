...
router.get('/', isAuthenticated, function (req, res) {
    res.render(
        'admin/dashboard', {title: config.BLOG_NAME + " | Admin", user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
    );
});
...
router.get('/thumbnails', isAuthenticated, function (req, res) {
    co(function *() {
        ...
        res.render(
            'admin/gallery.jade', {title: config.BLOG_NAME + " | Gallery", thumbnails: thumbnails, user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
        );
    }).catch(function (e) {
        console.log(e);
...
router.get('/categories', isAuthenticated, function (req, res) {
    co(function *() {
        ...
        res.render(
            'admin/categories.jade', {title: config.BLOG_NAME + " | Category", categories: categories, user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
        );
    }).catch(function (e) {
        console.log(e);
        util.renderError(res, e);
...
router.get('/tags', isAuthenticated, function (req, res) {
    co(function *() {
        ...
        res.render(
            'admin/tags.jade', {title: config.BLOG_NAME + " | Tags", tags: tags, user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
        );
    }).catch(function (e) {
        console.log(e);
        util.renderError(res, e);
...
router.get('/posts', isAuthenticated, function (req, res) {
    co(function *() {
        ...
        res.render(
            'admin/posts.jade', {title: config.BLOG_NAME + " | Posts", posts: posts, user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
        );
    }).catch(function (e) {
...
router.get('/posts/new', function (req, res) {
    co(function *() {
        let categories = (yield categoryModel.findAll());
        res.render(
            'admin/post_editor.jade', {title: config.BLOG_NAME + " | Post Editor", post: null, categories: categories, user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
        );
    }).catch(function (e) {
        util.sendResponse(res, 500, e.message);
        console.log(e);
...
router.get('/posts/edit/:id', function (req, res) {
    co(function *() {
        ...
        let categories = (yield categoryModel.findAll());
        res.render(
            'admin/post_editor.jade', {title: config.BLOG_NAME + " | Post Editor", post: post, categories: categories, user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
        );
    }).catch(function (e) {
        util.sendResponse(res, 500, e.message);
        console.log(e);
...
router.get('/passwordReset', function (req, res) {
    res.render(
        'admin/password_reset.jade', {title: config.BLOG_NAME + " | Password Reset", user: {photo: req.cookies.user.image_path, username: req.cookies.user.username}}
    );
});
